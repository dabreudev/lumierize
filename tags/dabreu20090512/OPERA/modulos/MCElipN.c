...
/*  ---------------------------- */
  ...
  if(!gaussj(aa , nvec , bb , 1)) return(0) ;
  ...
  free_matrix_f(aa,nvec,nvec);
  free_matrix_f(bb,nvec,1);
  free(cc);
  return(1);
}

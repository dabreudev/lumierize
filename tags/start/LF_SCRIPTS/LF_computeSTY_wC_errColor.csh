...
# TITLE: Script para calcular LF con LumFunc_GOYA utilizando STY_wC_errColor
# CREATED: 20080331 dabreu
# Pequeño script para calcular la LF utilizando la opción STY_wC_errColor en
# magnitudes
#
...
if ($1 == "--help") then
   echo "Uso: LF_computeSTY_wC_errColor.csh inCat colorMean colorStddev magLim zlow zup area outFile"
   echo ""
   echo "Example: LF_computeSTY_wC_errColor.csh kk.cat 0 0.001 25 0 0 0.1 kk.lf"
   exit
endif

...
/*   double parconf[2]; */
  ...
  double par0_conf_min;
  double par0_conf_max;
  double par1_conf_min;
  double par1_conf_max;
...
/*   if((p[1])<=meanerrx/500.) p[1]=wsigma;  */
  ...
  if(DEBUG) printf(" mlF iter %3d logL %15g  p0 %f p1 %f ndata %d\n",iter_m,logL,p[0],p[1],ndata);

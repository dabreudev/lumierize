...
/*Creado para tener un histograma de dos dimensiones en el caso del c�lculo de la fracci�n de fusiones*/
  int nbinx;
  double *p;
  double **covp;
  double *xbin;
...
/* Modificado para tener en cuenta las dos variables de entrada. Terminado.*/
  ...
  /* Se a�ade la opci�n D para leer los datos 2D y la opci�n K para obtener el histograma de 2D*/
  /* Se a�ade la opci�n F para determinar directamente los valores de la fracci�n de fusiones */
  do{
    printf("\n R Read sample\n"); 
...
/* Desarrollado para hacer el estudio en dos variables.*/
  ...
  /*A�adido para obtener los valores de y*/
  ...
  /* A�adido ydata, errydata, xbin e ybin*/ 
  ...
  /* Aqui van los resultados. Sale en forma de matriz kl... �estar� todo ok? :-O */  
...
void Compute_ff_gg(void)
{
/* Desarrollado para hacer el estudio en dos variables y determinar directamente la fracci�n de fusiones*/
  ...
  printf(" Input maximum y value for the distribution (no allowed values above this number for the original distribution): ");
  HD.ymax=(double)readf(HD.ymax);
  No me interesa, ya que solo es importante el l�mite para fusi�n y el tama�o del intervalo en asimetr�a*/
  ...
  /* A�adido ydata, errydata, yff y yinter*/

...
/* PARA 10 constantes
   ...
   void PlateCtes_10(int ndat, float *xdat, float *ydat, float *alfa,float *delta,float alfac,float deltac,struct plt_cte *constantes) { */
   /*
     ...
     psi=ap+bpx+cpy+dpx2+epy2+fpxy+gpx3+hpy3+ppx2y+qpxy2
     eta=ae+bex+cey+dex2+eey2+fexy+gex3+hey3+pex2y+qexy2
...
float x[3];
  ...
  constantes->e=x[1];
  constantes->f=x[2];
  //printf("JODERRRRRRRRRRRRRRRRRRRRRR\n");
